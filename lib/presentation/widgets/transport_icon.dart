...
class TransportIcon extends StatelessWidget {
  ...
  final bool isGroundSegment; // If true, overrides type to show truck for last mile
  ...
  Widget _buildWrapper(Widget icon, {bool pulse = false}) {
    Widget child = Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: primaryColor.withOpacity(0.2), blurRadius: size * 0.5)]
      ),
      child: icon,
    );
         ...
         children: [
           ...
           Positioned(
             ...
             child: FadeInRight(
               ...
               child: Icon(Icons.air, color: Colors.white.withOpacity(0.5), size: size * 0.5)
             )
           )
         ],
       ),
      ...
      Stack(
        ...
        children: [
           ...
           Positioned(
             top: -size * 0.1,
             child: SlideInDown(
               child: Icon(Icons.calendar_view_day, color: Colors.blueAccent, size: size * 0.6)
             )
           )
        ],
      )
        ...
        children: [
           ...
           Positioned(
             ...
             child: Row(
               ...
               children: [
                 BounceInDown(delay: const Duration(milliseconds: 100), child: Icon(Icons.inventory_2, color: Colors.orange, size: size * 0.4)),
                 BounceInDown(delay: const Duration(milliseconds: 300), child: Icon(Icons.inventory_2, color: Colors.orange, size: size * 0.4)),
               ],
             )
           )
        ],
         ...
         children: [
           ...
           Positioned(
             ...
             child: SlideInRight(
               ...
               child: Container(width: size, height: 2, color: Colors.grey.withOpacity(0.5))
             )
           )
         ],
       )
